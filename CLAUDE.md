...
**Note:** Vulnerability scanning is handled primarily via GitHub Dependabot alerts and CI security tools (Trivy). If you need a local audit check, you can run `pnpm audit` directly (though it is not defined as an npm script in `package.json`).
