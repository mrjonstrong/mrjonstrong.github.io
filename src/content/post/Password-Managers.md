...
- Resistance to SIM-swapping and TOTP interception attacks.
...
Passkey support is rolling out quickly. Check [1Password's passkey directory](https://passkeys.directory) to see which sites support them. Where available, prefer a passkey over a password + TOTP combination.
